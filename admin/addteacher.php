      ...
      <nav class="teal">
        <div class="container">
          <div class="nav-wrapper">
            <a href="" class="brand-logo center">MKCE</a>
                            ...
                            <div class="col l4">
                                <div class="input-field">
                                    <select name="position" required="required">
                                            ...
                                            <option value="AIDS STAFF">AIDS STAFF</option>
                                            <option value="CSBS STAFF">CSBS STAFF</option>
                                            <option value="ECE STAFF">ECE STAFF</option>
                                            <option value="EEE STAFF">EEE STAFF</option>
                                            <option value="MECH STAFF">MECH STAFF</option>
                                            <option value="CIVIL STAFF">CIVIL STAFF</option>
                                            <option value="MBA STAFF">MBA STAFF</option>
                                            <option value="MCA STAFF">MCA STAFF</option>
                                            <option value="BCA STAFF">BCA STAFF</option>
                                    </select>
                                </div>
                                <div class="input-field">
