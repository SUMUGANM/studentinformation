...
<nav class="brown darken-4">
    <div class="container">
        <a class="brand-logo hide-on-med-and-down" href="">M.KUMARASAMY COLLEGE OF ENGINEERING</a>
    <ul class="right">
   ...
   <body style="background-image:url(images/mkce.jpg); background-size: 150% 150%; background-repeat: no-repeat; ">
    <div class="row">
            <div class="col l4 offset-l4 m12 s12">
                <div class="card-panel with-header" style="border-radius: 30px; opacity: 0.9; margin-top: 50%;">
